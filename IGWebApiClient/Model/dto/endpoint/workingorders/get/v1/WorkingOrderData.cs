...
public class WorkingOrderData{
	...
	///</Summary>
	public double? trailingTriggerIncrement { get; set; }
	///<Summary>
	///Trailing stop distance
	///</Summary>
	public double? trailingTriggerDistance { get; set; }
	///<Summary>
	///Trailing stop distance
	///</Summary>
	...
	///Stop level
	///</Summary>
	public double? contingentStop { get; set; }
	///<Summary>
	///Currency ISO code
	///</Summary>
	...
	///Limit level
	///</Summary>
	public double? contingentLimit { get; set; }
	///<Summary>
